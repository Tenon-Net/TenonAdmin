...
只有任务计划 T01–T25 全部完成、“完成条件”全部有证据、独立审查无 blocker 且权威文档已同步时，才将本 goal 标记完成。完成时只能声明“M3a-2 Vue 阶段完成”；完整 M3a-2 和 GA 仍等待 React port。最终报告列出完成任务、关键语义、修改文件、验证结果、参考依据、剩余边界和下一阶段。
```
