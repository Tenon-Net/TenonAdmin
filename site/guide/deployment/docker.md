...
This page helps you run TenonAdmin fully containerized — one `docker compose up` brings up MySQL + Redis + backend + frontend — and then scale it safely to multiple replicas.
