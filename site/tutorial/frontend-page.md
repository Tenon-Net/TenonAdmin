...
Continuing from the previous guide, [Add a Business Module End-to-End](/tutorial/business-module) — the backend already has the `GET/POST/PUT/DELETE /api/v1/sample/doc` set of endpoints. This guide turns them into a working admin page.
...
Once the page is working, if you want to ship the whole system, see the next guide: [Full Container Deployment Walkthrough](/tutorial/docker-deploy).
