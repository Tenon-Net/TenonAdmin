export default {
  ...
  job: {
    ...
    form: {
      ...
      timeoutHint: '0 = unlimited; on timeout the run is cancelled and recorded as Timeout',
      retryCount: 'Retry count',
      retryInterval: 'Retry interval',
      failAlertThreshold: 'Failure alert threshold',
      failAlertHint: 'Alert and panic after this many consecutive failures; 0 = never',
