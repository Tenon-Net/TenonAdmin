export default {
  ...
  personalSecurity: {
    ...
    hint: 'Manage your authenticator (TOTP) here. Requires TenonAdmin:Security:Totp:Enabled on the server.',
    ...
    note: 'You can also open the setup page from the login screen.',
  },
  changePassword: {
