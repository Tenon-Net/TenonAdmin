export default {
  ...
  mfaBind: {
    ...
    tokenRequired: 'This enrollment link is missing its token.',
    ...
    recoveryHint: 'These codes are shown once. Store them somewhere secure; each code can be used only once.',
    copy: 'Copy',
    useRecovery: 'Use a recovery code',
    backToBind: 'Set up authenticator',
    recoveryModeTitle: 'Use recovery code',
    recoveryModeHint: 'A recovery code removes your existing authenticator binding.',
    account: 'Account',
    ...
    recoveryRebind: 'Ask an administrator to send a new authenticator enrollment invitation before signing in again.',
    inviteResponseIncomplete: 'The enrollment invitation response was incomplete. Issue a new invitation.',
  ...
  error: {
    ...
    auth: {
      ...
      bindInviteInvalid: 'Binding invite is invalid or expired',
