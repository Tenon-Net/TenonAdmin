export default {
  ...
  mfa: {
    ...
    stepVerify: 'Verify', stepAuthenticator: 'Authenticator', stepRecovery: 'Recovery codes', bindHint: 'Enter the invitation token and your current password to begin.',
    inviteToken: 'Invitation token', accountOptional: 'Account (only for initialization grants)', currentPassword: 'Current password', startBind: 'Start setup',
    bindRequired: 'Enter the invitation token and current password', manualSetupHint: 'Add this key to an authenticator app, then enter its current code.',
    ...
    recoveryOnce: 'Save these recovery codes now. Each can be used once and they will not be displayed again.', copy: 'Copy', copied: 'Copied to clipboard', copyFailed: 'Copy failed; select and copy manually', copyAll: 'Copy all codes',
    backToLogin: 'Back to sign in', recoveryHint: 'A recovery code removes your authenticator and signs out existing sessions.', account: 'Account', recoveryCode: 'Recovery code', submitRecovery: 'Use recovery code', recoveryRequired: 'Enter your account, current password, and recovery code', recoveryDone: 'Authenticator removed. Sign in again and complete a new setup if required.',
    inviteResponseIncomplete: 'The invitation response was incomplete. Issue a new invitation.', bindStartResponseIncomplete: 'The setup response was incomplete. Start the setup again.', bindCompleteResponseIncomplete: 'The setup response was incomplete. Start the setup again.',
  },
  reauth: {
